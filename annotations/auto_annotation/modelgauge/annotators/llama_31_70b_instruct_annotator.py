...
LLAMA_3_1_70B_PE_SUTRO_2024_08_01_CONFIG = PromptEngineeredAnnotatorConfig(
    name="llama-3.1-70b.pe.sutro.2024-08-01",
    description="First Llama 3.1 70b model, using the v0.5 April 2024 taxonomy",
...
LLAMA_3_1_70B_PE_TAMALPAIS_2024_09_09_CONFIG = PromptEngineeredAnnotatorConfig(
    name="llama-3.1-70b.pe.tamalpais.2024-09-01",
    description="Llama 3.1 70b prompt engineered model using the v1.0 September 2024 taxonomy",
    llm_config=TogetherModelConfig(
        path="meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo",
        api_key=TogetherApiKey(os.environ.get("TOGETHER_API_KEY")),
    ),
...
ANNOTATORS.register(
    PromptEngineeredAnnotator,
    LLAMA_3_1_70B_PE_SUTRO_2024_08_01_CONFIG.name,
    LLAMA_3_1_70B_PE_SUTRO_2024_08_01_CONFIG,
)
ANNOTATORS.register(
    PromptEngineeredAnnotator,
    LLAMA_3_1_70B_PE_TAMALPAIS_2024_09_09_CONFIG.name,
    LLAMA_3_1_70B_PE_TAMALPAIS_2024_09_09_CONFIG,
)
